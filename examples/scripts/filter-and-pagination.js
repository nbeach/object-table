(function(){
    ...
    function FilterAndPaginationExampleCtrl(exampleData) {

        //Initializing property to store the filtered set of objects. This is then bound to the pagination directive
        this.dataFiltered = [];
    ...
    angular
        .module('filterAndPaginationExampleApp', ['objectTable', 'ExampleData'])
        .controller('FilterAndPaginationExampleCtrl', FilterAndPaginationExampleCtrl);
